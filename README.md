...
#  LDAP Server listenning on 10389 handling only BindRequest
```Go
package main
...
#  LDAP SSL Server listenning on 10636 handling only BindRequest
```Go
package main
...
#  LDAP Server listenning on 10389 with StartTLS support
```Go
package main
...
# Complex LDAP Server handling all ldap operation
See file example/demoComplex.go